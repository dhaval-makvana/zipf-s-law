...
export default ChartComponent => (
    ...
    class ResponsiveChart extends Component {
        ...
        fitParentContainer() {
            ...
            const currentContainerWidth = window.innerWidth * .7;
            const currentContainerHeight = window.innerHeight * .7;

            console.log("current h", containerHeight, currentContainerHeight);
            console.log("current w", containerWidth, currentContainerWidth);
